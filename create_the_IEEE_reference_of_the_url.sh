...
obtain_the_attributes_of_the_url()
{
	...
	if [[ $the_name_of_the_attribute != $the_name_of_the_old_attribute ]]
	then
	    initialize_the_attribute_of_the_url $the_name_of_the_old_attribute $attribute
	    the_name_of_the_old_attribute=$the_name_of_the_attribute
	    attribute=""
	fi
